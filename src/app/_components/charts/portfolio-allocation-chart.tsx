...
const COLORS = ['#0088FE', '#00C49F', '#FFBB28', '#FF8042', '#884d8', '#82ca9d'];

export function PortfolioAllocationChart({ standalone = true }: PortfolioAllocationChartProps) {
  ...
  const calculateChartData = () => {
    try {
      ...
      const data = holdings.map((holding: CalculatedPortfolioHolding) => ({
        name: holding.asset,
