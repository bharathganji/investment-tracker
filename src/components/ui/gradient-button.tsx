...
const GradientButton = React.forwardRef<HTMLButtonElement, GradientButtonProps>(
  ({ className, variant = "primary", isLoading = false, children, ...props }, ref) => {
    ...
    const variantClasses = {
      primary: "bg-gradient-to-r from-blue-500 to-teal-500 text-white hover:from-blue-600 hover:to-teal-600 shadow-lg hover:shadow-xl transform transition-transform duration-200 hover:scale-105 active:scale-95",
