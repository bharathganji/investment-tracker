...
export function DashboardStats() {
  ...
  }, [trades.length, holdings.length, tradesLoading, calculateStats]); // Depend on actual arrays to trigger recalculations
  ...
  return (
    <AnimatedCardGrid>
      ...
      >
        <EnhancedCard
          className="duration-30 rounded-xl shadow-md transition-shadow hover:shadow-lg"
          animateOnHover
        >
          ...
          <EnhancedCardContent>
            <div className="financial-number text-3xl font-bold">
              {totalTradesCount.formattedValue}
            </div>
          </EnhancedCardContent>
        </EnhancedCard>
      </motion.div>
      ...
      >
        ...
        >
          ...
          <EnhancedCardContent>
            <div
              className={`financial-number text-3xl font-bold ${portfolioValueCount.value >= 0 ? financialColors.profit : financialColors.loss}`}
            >
      ...
      >
        ...
        >
          ...
          <EnhancedCardContent>
            <div
              className={`financial-number text-3xl font-bold ${totalPnLCount.value >= 0 ? financialColors.profit : financialColors.loss}`}
            >
      ...
      >
        ...
        >
          ...
          <EnhancedCardContent>
            <div
              className={`financial-number text-3xl font-bold ${roiCount.value >= 0 ? financialColors.profit : financialColors.loss}`}
            >
